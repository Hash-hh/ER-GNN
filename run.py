...
def main(fixed):
    ...
    assert (args.only_downstream and not hasattr(args, 'sample_configs') and not hasattr(args, 'imle_configs')) or \
           (not args.only_downstream and hasattr(args, 'sample_configs') and hasattr(args, 'imle_configs')), \
            "Configuration mismatch: Check 'only_downstream' flag and presence of 'sample_configs' and 'imle_configs'."
